...
public class ClassTreeExample {
    ...
    public ClassTreeExample( String ontology ) throws Exception {
        // create a reasoner
...
//        ClassTreeExample tree = new ClassTreeExample( args[0] );

        ClassTreeExample tree = new ClassTreeExample( fileUri.toString() );
